...
public class NfcTagServiceTests
{
    ...
    public NfcTagServiceTests() =>
        _sut = new NfcTagService(_repo, NullLogger<NfcTagService>.Instance);
    ...
    [Fact]
    public async Task RegisterAsync_CreatesTagWithCorrectFields()
    {
    ...
    public async Task RegisterAsync_CallsRepositoryCreateOnce()
    {
        ...
        await _sut.RegisterAsync(new RegisterNfcTagRequest("04:AA:BB:CC", Guid.NewGuid(), "NFC-A"));
